...
CREATE TABLE "SafetyMeasures" (
    ...
    CONSTRAINT fk_order_measures FOREIGN KEY (order_id)
...
CREATE TABLE "Atmosphere" (
    ...
    REFERENCES "SafetyMeasures" (measure_id) ON DELETE CASCADE
);
...
CREATE TABLE "MediaMaterials" (
    ...
    CONSTRAINT fk_atmosphere FOREIGN KEY (atmosphere_id)
    REFERENCES "Atmosphere" (atmosphere_id) ON DELETE CASCADE
);
